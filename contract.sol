...
contract Contractname is ERC721A, Ownable, ReentrancyGuard {
    ...
    address reserveWallet = payable(0x4E244a34030Ad371a2d15318c4E1f6a0fC1fA83D);

    string public uriPrefix = "";
    string public uriSuffix = "";

    uint256 public constant maxWalletMint = 5;
    ...
    function setReserve(address payable _reserveWallet) public onlyOwner {
        ...
        mintPriceCompliance(_mintAmount)
    {
        ...
        require(
            walletMints[msg.sender] <= maxWalletMint,
            "You reached mint limit"
        );

        _safeMint(_msgSender(), _mintAmount);
    }

    function increaseMaxSupply(uint256 _addSupply)
        public
        onlyOwner
    {
